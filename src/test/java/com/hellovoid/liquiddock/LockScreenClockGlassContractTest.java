...
public class LockScreenClockGlassContractTest {
    ...
    @Test public void runtimeDirectlyReplacesClockWithoutVendorGlassCapability() throws Exception {
        ...
        assertTrue(composite.contains("uRootPxToMaskUv"));
        assertTrue(composite.contains("uComponentLitRim"));
        assertTrue(composite.contains("uComponentOppositeRim"));
        assertTrue(composite.contains("uComponentFaceSheen"));
        assertTrue(composite.contains("litHairline"));
        assertTrue(composite.contains("oppGlow"));
        assertTrue(composite.contains("faceSheenSoft"));
        assertTrue(composite.contains("gl_FragColor = vec4(color * alpha, alpha)"));
        ...
        assertTrue(session.contains("uRootSize"));
