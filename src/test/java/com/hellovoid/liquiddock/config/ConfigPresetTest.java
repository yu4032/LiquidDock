...
public class ConfigPresetTest {
    ...
    public void defaultPresetPreservesIntentionalOverridesAndIncludesNewSchemaKeys() {
        ...
        assertEquals(Integer.valueOf(-94), defaults.get(ConfigSchema.Grid.LANDSCAPE_INDICATOR_Y.name() + "_tenths"));
        ...
        assertEquals(Integer.valueOf(72), defaults.get(ConfigSchema.Glass.BLUR.name() + "_tenths"));
        assertEquals(Integer.valueOf(165), defaults.get(ConfigSchema.Glass.ICON_CORNER_RADIUS.name() + "_tenths"));
        assertEquals(Integer.valueOf(6), defaults.get(ConfigSchema.Glass.DIALOG_BLUR.name()));
