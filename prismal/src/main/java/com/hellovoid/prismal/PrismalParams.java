...
public final class PrismalParams {
    ...
    public final float os4ThicknessPx;
    public final float os4ReflectOffsetPx;
    public final float os4BloomWidthPx;
    public final float os4BloomIntensity;
    public final float os4BloomBlurRadiusPx;
    public final boolean os4BloomEnabled;
    ...
    private PrismalParams(Builder b) {
        ...
        os4ThicknessPx = b.os4ThicknessPx;
        os4ReflectOffsetPx = b.os4ReflectOffsetPx;
        os4BloomWidthPx = b.os4BloomWidthPx;
        os4BloomIntensity = b.os4BloomIntensity;
        os4BloomBlurRadiusPx = b.os4BloomBlurRadiusPx;
        os4BloomEnabled = b.os4BloomEnabled;
