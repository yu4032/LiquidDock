...
public class ConfigCodecTest {
 ...
 Map<String,Object> e=ConfigCodec.exportValues(new HashMap<>()); assertEquals(143,e.size()); assertEquals(Boolean.FALSE,e.get("liquid_glass")); assertEquals(Boolean.TRUE,e.get("liquid_folder_glass")); assertFalse(e.containsKey("liquid_folder_corner_radius")); assertEquals(Boolean.TRUE,e.get("liquid_small_folder_glass")); assertEquals(Boolean.TRUE,e.get("liquid_large_folder_glass")); assertEquals(0.0d,((Number)e.get("liquid_icon_size_offset")).doubleValue(),.0001d); assertEquals(0.0d,((Number)e.get("liquid_widget_corner_radius")).doubleValue(),.0001d); assertEquals(0.0d,((Number)e.get("liquid_small_folder_corner_radius")).doubleValue(),.0001d); assertEquals(0.0d,((Number)e.get("liquid_large_folder_corner_radius")).doubleValue(),.0001d); assertEquals(0.0d,((Number)e.get("workstation_dock_icon_glass_corner_radius")).doubleValue(),.0001d); assertEquals(100,e.get("recents_background_blur_percent"));
    }
