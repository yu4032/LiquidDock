...
/** Keeps the LiquidDock-owned PassBlur producer authoritative for Baidu Input Method. */
final class BaiduInputMethodPassBlurContinuousAuthority {
    ...
    private BaiduInputMethodPassBlurContinuousAuthority() {}
    ...
    static boolean install() {
        synchronized (LOCK) {
            ...
            try {
                ...
                log("continuous PassBlur authority unavailable cause=" + failureSummary(error));
                return false;
            }
        }
    }
