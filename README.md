...
- **液态玻璃改造**：针对 HyperOS 3.0.307+，使用系统 PassBlur 方法、GLES、Prismal 项目液态玻璃模型完成折射、色散、镜面、焦散、高光等光学效果，以及模仿 HyperOS 4 的类柔光玻璃高光描边。支持 Dock、小组件（支持自定义）、文件夹、桌面图标（需配合透明图标主题），可自定义尺寸与圆角。
